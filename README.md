...
- Cost-aware routing, automatic small-model execution on cheap turns, cached execution scaffolds reused across sessions, caveman compression, idle-cliff carry-forward, and token/budget telemetry
