...
export const HOME_TIPS = [
  ...
  "Use /login or /connect to connect Codex, Claude Code, Copilot, Gemini CLI, or Antigravity with OAuth.",
  "Use /connect as a natural alias for /login when adding OAuth providers.",
