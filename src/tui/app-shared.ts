...
export const HOME_TIPS = [
  ...
  "Use /providers when a configured model looks wrong.",
  "Set OPENAI_API_KEY, ANTHROPIC_API_KEY, GOOGLE_GENERATIVE_AI_API_KEY, MISTRAL_API_KEY, or XAI_API_KEY before starting.",
